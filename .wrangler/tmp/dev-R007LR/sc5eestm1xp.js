...
// .wrangler/tmp/pages-1PtEA0/bundledWorker-0.5121690097998508.mjs
...
var f;
var l = E(() => {
  f = { version: 3, routes: { none: [{ src: "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$", headers: { Location: "/$1" }, status: 308, continue: true }, { src: "^/_next/__private/trace$", dest: "/404", status: 404, continue: true }, { src: "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$", headers: { "X-Content-Type-Options": "nosniff", "X-Frame-Options": "DENY", "X-XSS-Protection": "1; mode=block", "Referrer-Policy": "strict-origin-when-cross-origin", "Permissions-Policy": "camera=(), microphone=(), geolocation=()" }, continue: true }, { src: "^/404/?$", status: 404, continue: true, missing: [{ type: "header", key: "x-prerender-revalidate" }] }, { src: "^/500$", status: 500, continue: true }, { src: "^/?$", has: [{ type: "header", key: "rsc", value: "1" }], dest: "/index.rsc", headers: { vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" }, continue: true, override: true }, { src: "^/((?!.+\\.rsc).+?)(?:/)?$", has: [{ type: "header", key: "rsc", value: "1" }], dest: "/$1.rsc", headers: { vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" }, continue: true, override: true }], filesystem: [{ src: "^/index(\\.action|\\.rsc)$", dest: "/", continue: true }, { src: "^/_next/data/(.*)$", dest: "/_next/data/$1", check: true }, { src: "^/\\.prefetch\\.rsc$", dest: "/__index.prefetch.rsc", check: true }, { src: "^/(.+)/\\.prefetch\\.rsc$", dest: "/$1.prefetch.rsc", check: true }, { src: "^/\\.rsc$", dest: "/index.rsc", check: true }, { src: "^/(.+)/\\.rsc$", dest: "/$1.rsc", check: true }], miss: [{ src: "^/_next/static/.+$", status: 404, check: true, dest: "/_next/static/not-found.txt", headers: { "content-type": "text/plain; charset=utf-8" } }], rewrite: [{ src: "^/_next/data/(.*)$", dest: "/404", status: 404 }, { src: "^/address/(?<nxtPaddress>[^/]+?)(?:\\.rsc)(?:/)?$", dest: "/address/[address].rsc?nxtPaddress=$nxtPaddress" }, { src: "^/address/(?<nxtPaddress>[^/]+?)(?:/)?$", dest: "/address/[address]?nxtPaddress=$nxtPaddress" }, { src: "^/hash/(?<nxtPid>[^/]+?)(?:\\.rsc)(?:/)?$", dest: "/hash/[id].rsc?nxtPid=$nxtPid" }, { src: "^/hash/(?<nxtPid>[^/]+?)(?:/)?$", dest: "/hash/[id]?nxtPid=$nxtPid" }, { src: "^/momentum/(?<nxtPid>[^/]+?)(?:\\.rsc)(?:/)?$", dest: "/momentum/[id].rsc?nxtPid=$nxtPid" }, { src: "^/momentum/(?<nxtPid>[^/]+?)(?:/)?$", dest: "/momentum/[id]?nxtPid=$nxtPid" }, { src: "^/pillar/(?<nxtPaddress>[^/]+?)(?:\\.rsc)(?:/)?$", dest: "/pillar/[address].rsc?nxtPaddress=$nxtPaddress" }, { src: "^/pillar/(?<nxtPaddress>[^/]+?)(?:/)?$", dest: "/pillar/[address]?nxtPaddress=$nxtPaddress" }, { src: "^/token/(?<nxtPzts>[^/]+?)(?:\\.rsc)(?:/)?$", dest: "/token/[zts].rsc?nxtPzts=$nxtPzts" }, { src: "^/token/(?<nxtPzts>[^/]+?)(?:/)?$", dest: "/token/[zts]?nxtPzts=$nxtPzts" }, { src: "^/transaction/(?<nxtPhash>[^/]+?)(?:\\.rsc)(?:/)?$", dest: "/transaction/[hash].rsc?nxtPhash=$nxtPhash" }, { src: "^/transaction/(?<nxtPhash>[^/]+?)(?:/)?$", dest: "/transaction/[hash]?nxtPhash=$nxtPhash" }], resource: [{ src: "^/.*$", status: 404 }], hit: [{ src: "^/_next/static/(?:[^/]+/pages|pages|chunks|runtime|css|image|media|yBh5BK4y8GfmiI3UugIVw)/.+$", headers: { "cache-control": "public,max-age=31536000,immutable" }, continue: true, important: true }, { src: "^/index(?:/)?$", headers: { "x-matched-path": "/" }, continue: true, important: true }, { src: "^/((?!index$).*?)(?:/)?$", headers: { "x-matched-path": "/$1" }, continue: true, important: true }], error: [{ src: "^/.*$", dest: "/404", status: 404 }, { src: "^/.*$", dest: "/500", status: 500 }] }, images: { domains: [], sizes: [640, 750, 828, 1080, 1200, 1920, 2048, 3840, 16, 32, 48, 64, 96, 128, 256, 384], remotePatterns: [], minimumCacheTTL: 60, formats: ["image/webp"], dangerouslyAllowSVG: false, contentSecurityPolicy: "script-src 'none'; frame-src 'none'; sandbox;", contentDispositionType: "attachment" }, overrides: { "404.html": { path: "404", contentType: "text/html; charset=utf-8" }, "500.html": { path: "500", contentType: "text/html; charset=utf-8" }, "_error.rsc.json": { path: "_error.rsc", contentType: "application/json" }, "_app.rsc.json": { path: "_app.rsc", contentType: "application/json" }, "_document.rsc.json": { path: "_document.rsc", contentType: "application/json" }, "404.rsc.json": { path: "404.rsc", contentType: "application/json" }, "_next/static/not-found.txt": { contentType: "text/plain" } }, framework: { version: "15.5.2" }, crons: [] };
});
var m;
var p = E(() => {
  m = { "/404.html": { type: "override", path: "/404.html", headers: { "content-type": "text/html; charset=utf-8" } }, "/404.rsc.json": { type: "override", path: "/404.rsc.json", headers: { "content-type": "application/json" } }, "/500.html": { type: "override", path: "/500.html", headers: { "content-type": "text/html; charset=utf-8" } }, "/_app.rsc.json": { type: "override", path: "/_app.rsc.json", headers: { "content-type": "application/json" } }, "/_document.rsc.json": { type: "override", path: "/_document.rsc.json", headers: { "content-type": "application/json" } }, "/_error.rsc.json": { type: "override", path: "/_error.rsc.json", headers: { "content-type": "application/json" } }, "/_next/static/chunks/173-6e7a92f5bcec21c6.js": { type: "static" }, "/_next/static/chunks/176-b293c0b8f74aca36.js": { type: "static" }, "/_next/static/chunks/255-e3bf15caf1f1e0f9.js": { type: "static" }, "/_next/static/chunks/4bd1b696-c023c6e3521b1417.js": { type: "static" }, "/_next/static/chunks/762-cd11dfd377b0ee02.js": { type: "static" }, "/_next/static/chunks/932-f5afc5307c992d96.js": { type: "static" }, "/_next/static/chunks/943-e6152fc6d89f3b24.js": { type: "static" }, "/_next/static/chunks/app/_not-found/page-e77ee548964494a5.js": { type: "static" }, "/_next/static/chunks/app/address/[address]/page-66499e321ad872a0.js": { type: "static" }, "/_next/static/chunks/app/hash/[id]/page-375f0d4d8acd01c2.js": { type: "static" }, "/_next/static/chunks/app/layout-86e1a73066238c2a.js": { type: "static" }, "/_next/static/chunks/app/momentum/[id]/page-5c3448b53e3d6658.js": { type: "static" }, "/_next/static/chunks/app/momentums/page-aada97dca8d60f58.js": { type: "static" }, "/_next/static/chunks/app/page-79685f0fad7eefe7.js": { type: "static" }, "/_next/static/chunks/app/pillar/[address]/page-c1661665d06e5ec4.js": { type: "static" }, "/_next/static/chunks/app/pillars/page-8f60536f2d669ece.js": { type: "static" }, "/_next/static/chunks/app/sentinels/page-893446b736c6f464.js": { type: "static" }, "/_next/static/chunks/app/token/[zts]/page-afa26f6bc43fbcfe.js": { type: "static" }, "/_next/static/chunks/app/tokens/page-a3838fe04848a420.js": { type: "static" }, "/_next/static/chunks/app/transaction/[hash]/page-9634fefe65e7cefe.js": { type: "static" }, "/_next/static/chunks/app/transactions/page-06ba32a7d1036c13.js": { type: "static" }, "/_next/static/chunks/framework-a6e0b7e30f98059a.js": { type: "static" }, "/_next/static/chunks/main-989d96afe5bc1a55.js": { type: "static" }, "/_next/static/chunks/main-app-d3ede929997815a6.js": { type: "static" }, "/_next/static/chunks/pages/_app-7d307437aca18ad4.js": { type: "static" }, "/_next/static/chunks/pages/_error-cb2a52f75f2162e2.js": { type: "static" }, "/_next/static/chunks/polyfills-42372ed130431b0a.js": { type: "static" }, "/_next/static/chunks/webpack-01e7dd0b6d0e9da1.js": { type: "static" }, "/_next/static/css/40676d002aa74d73.css": { type: "static" }, "/_next/static/media/4cf2300e9c8272f7-s.p.woff2": { type: "static" }, "/_next/static/media/747892c23ea88013-s.woff2": { type: "static" }, "/_next/static/media/8d697b304b401681-s.woff2": { type: "static" }, "/_next/static/media/93f479601ee12b01-s.p.woff2": { type: "static" }, "/_next/static/media/9610d9e46709d722-s.woff2": { type: "static" }, "/_next/static/media/ba015fad6dcf6784-s.woff2": { type: "static" }, "/_next/static/not-found.txt": { type: "static" }, "/_next/static/yBh5BK4y8GfmiI3UugIVw/_buildManifest.js": { type: "static" }, "/_next/static/yBh5BK4y8GfmiI3UugIVw/_ssgManifest.js": { type: "static" }, "/file.svg": { type: "static" }, "/globe.svg": { type: "static" }, "/next.svg": { type: "static" }, "/vercel.svg": { type: "static" }, "/window.svg": { type: "static" }, "/address/[address]": { type: "function", entrypoint: "__next-on-pages-dist__/functions/address/[address].func.js" }, "/address/[address].rsc": { type: "function", entrypoint: "__next-on-pages-dist__/functions/address/[address].func.js" }, "/hash/[id]": { type: "function", entrypoint: "__next-on-pages-dist__/functions/hash/[id].func.js" }, "/hash/[id].rsc": { type: "function", entrypoint: "__next-on-pages-dist__/functions/hash/[id].func.js" }, "/momentum/[id]": { type: "function", entrypoint: "__next-on-pages-dist__/functions/momentum/[id].func.js" }, "/momentum/[id].rsc": { type: "function", entrypoint: "__next-on-pages-dist__/functions/momentum/[id].func.js" }, "/pillar/[address]": { type: "function", entrypoint: "__next-on-pages-dist__/functions/pillar/[address].func.js" }, "/pillar/[address].rsc": { type: "function", entrypoint: "__next-on-pages-dist__/functions/pillar/[address].func.js" }, "/token/[zts]": { type: "function", entrypoint: "__next-on-pages-dist__/functions/token/[zts].func.js" }, "/token/[zts].rsc": { type: "function", entrypoint: "__next-on-pages-dist__/functions/token/[zts].func.js" }, "/transaction/[hash]": { type: "function", entrypoint: "__next-on-pages-dist__/functions/transaction/[hash].func.js" }, "/transaction/[hash].rsc": { type: "function", entrypoint: "__next-on-pages-dist__/functions/transaction/[hash].func.js" }, "/404": { type: "override", path: "/404.html", headers: { "content-type": "text/html; charset=utf-8" } }, "/500": { type: "override", path: "/500.html", headers: { "content-type": "text/html; charset=utf-8" } }, "/_error.rsc": { type: "override", path: "/_error.rsc.json", headers: { "content-type": "application/json" } }, "/_app.rsc": { type: "override", path: "/_app.rsc.json", headers: { "content-type": "application/json" } }, "/_document.rsc": { type: "override", path: "/_document.rsc.json", headers: { "content-type": "application/json" } }, "/404.rsc": { type: "override", path: "/404.rsc.json", headers: { "content-type": "application/json" } }, "/_not-found.html": { type: "override", path: "/_not-found.html", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/_not-found/layout,_N_T_/_not-found/page,_N_T_/_not-found", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/_not-found": { type: "override", path: "/_not-found.html", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/_not-found/layout,_N_T_/_not-found/page,_N_T_/_not-found", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/_not-found.rsc": { type: "override", path: "/_not-found.rsc", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/_not-found/layout,_N_T_/_not-found/page,_N_T_/_not-found", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch", "content-type": "text/x-component" } }, "/favicon.ico": { type: "override", path: "/favicon.ico", headers: { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/x-icon", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/index.html": { type: "override", path: "/index.html", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/page,_N_T_/", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/index": { type: "override", path: "/index.html", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/page,_N_T_/", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/": { type: "override", path: "/index.html", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/page,_N_T_/", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/index.rsc": { type: "override", path: "/index.rsc", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/page,_N_T_/", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch", "content-type": "text/x-component" } }, "/momentums.html": { type: "override", path: "/momentums.html", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/momentums/layout,_N_T_/momentums/page,_N_T_/momentums", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/momentums": { type: "override", path: "/momentums.html", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/momentums/layout,_N_T_/momentums/page,_N_T_/momentums", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/momentums.rsc": { type: "override", path: "/momentums.rsc", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/momentums/layout,_N_T_/momentums/page,_N_T_/momentums", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch", "content-type": "text/x-component" } }, "/pillars.html": { type: "override", path: "/pillars.html", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/pillars/layout,_N_T_/pillars/page,_N_T_/pillars", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/pillars": { type: "override", path: "/pillars.html", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/pillars/layout,_N_T_/pillars/page,_N_T_/pillars", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/pillars.rsc": { type: "override", path: "/pillars.rsc", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/pillars/layout,_N_T_/pillars/page,_N_T_/pillars", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch", "content-type": "text/x-component" } }, "/sentinels.html": { type: "override", path: "/sentinels.html", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/sentinels/layout,_N_T_/sentinels/page,_N_T_/sentinels", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/sentinels": { type: "override", path: "/sentinels.html", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/sentinels/layout,_N_T_/sentinels/page,_N_T_/sentinels", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/sentinels.rsc": { type: "override", path: "/sentinels.rsc", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/sentinels/layout,_N_T_/sentinels/page,_N_T_/sentinels", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch", "content-type": "text/x-component" } }, "/tokens.html": { type: "override", path: "/tokens.html", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/tokens/layout,_N_T_/tokens/page,_N_T_/tokens", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/tokens": { type: "override", path: "/tokens.html", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/tokens/layout,_N_T_/tokens/page,_N_T_/tokens", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/tokens.rsc": { type: "override", path: "/tokens.rsc", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/tokens/layout,_N_T_/tokens/page,_N_T_/tokens", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch", "content-type": "text/x-component" } }, "/transactions.html": { type: "override", path: "/transactions.html", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/transactions/layout,_N_T_/transactions/page,_N_T_/transactions", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/transactions": { type: "override", path: "/transactions.html", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/transactions/layout,_N_T_/transactions/page,_N_T_/transactions", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch" } }, "/transactions.rsc": { type: "override", path: "/transactions.rsc", headers: { "x-nextjs-stale-time": "300", "x-nextjs-prerender": "1", "x-next-cache-tags": "_N_T_/layout,_N_T_/transactions/layout,_N_T_/transactions/page,_N_T_/transactions", vary: "rsc, next-router-state-tree, next-router-prefetch, next-router-segment-prefetch", "content-type": "text/x-component" } } };
});
var q = V((We, F) => {
  "use strict";
  u();
...
var Q = V((U) => {
  ...
  function be(e, t) {
    ...
    for (var r = {}, s = t || {}, a = s.decode || Pe, i = 0; i < e.length; ) {
      var n = e.indexOf("=", i);
      if (n === -1) break;
      var o = e.indexOf(";", i);
      if (o === -1) o = e.length;
      ...
      if (r[c] === void 0) {
        ...
        h.charCodeAt(0) === 34 && (h = h.slice(1, -1)), r[c] = Se(h, a);
      }
      i = o + 1;
    }
    return r;
...
__name2(I, "I");
function M(e, t, r) {
  let { match: s, captureGroupKeys: a } = k(e, t);
...
function g(e, t, r) {
  ...
  for (let [a, i] of s) {
    let n = a.toLowerCase(), o = r?.match ? b(i, r.match, r.captureGroupKeys) : i;
...
__name(O, "O");
__name2(O, "O");
async function N(e, { request: t, assetsFetcher: r, ctx: s }, { path: a, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        n = P(await r.fetch(A(c, e.path ?? a))), e.headers && g(n.headers, e.headers);
        break;
      }
      case "static": {
...
function de(e, t) {
  ...
  let d = e.headers.get("Accept") ?? "", x = t?.formats?.find((R) => d.includes(R))?.replace("image/", "");
  return { isRelative: h, imageUrl: o, options: { width: i, quality: n, format: x } };
}
__name(de, "de");
__name2(de, "de");
function fe(e, t, r) {
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      case "GET": {
        let i = W(e, _e), n = await s.get(a, { softTags: i });
      ...
      case "POST": {
        let i = globalThis[xe], n = /* @__PURE__ */ __name2(async () => {
          let o = await e.json();
...
var j = class {
  ...
  checkRouteMatch(t, { checkStatus: r, checkIntercept: s }) {
    let a = k(t.src, this.path, t.caseSensitive);
  ...
  async runRouteMiddleware(t) {
    ...
    let s = await N(r, this.reqCtx, { path: this.path, searchParams: this.searchParams, headers: this.headers, status: this.status });
  ...
  applyRouteHeaders(t, r, s) {
    !t.headers || (g(this.headers.normal, t.headers, { match: r, captureGroupKeys: s }), t.important && g(this.headers.important, t.headers, { match: r, captureGroupKeys: s }));
  }
  applyRouteStatus(t) {
  ...
  applyLocaleRedirects(t) {
    ...
    let { locale: { redirect: s, cookie: a } } = t, i = a && this.cookies[a], n = L(i ?? ""), o = L(this.reqCtx.request.headers.get("accept-language") ?? ""), d = [...n, ...o].map((x) => s[x]).filter(Boolean)[0];
    if (d) {
  ...
  async checkRoute(t, r) {
    ...
    if (n.check && !T(this.path)) if (d === this.path) {
...
async function ee(e, t, r, s) {
  let a = new j(t.routes, r, e, s, t.wildcard), i = await te(a);
  return Ce(e, i, r);
}
__name(ee, "ee");
__name2(ee, "ee");
...
async function Ce(e, { path: t = "/404", status: r, headers: s, searchParams: a, body: i }, n) {
  ...
  if (i !== void 0) c = new Response(i, { status: r });
    ...
    let d = new URL(t);
    y(d.searchParams, a), c = await fetch(d, e.request);
  } else c = await N(n[t], e, { path: t, status: r, headers: s, searchParams: a });
  let h = s.normal;
...
var Ps = { async fetch(e, t, r) {
  ...
  return a.run({ ...t, NODE_ENV: "production", SUSPENSE_CACHE_URL: v }, async () => i.run({ env: t, ctx: r, cf: e.cf }, async () => {
    if (new URL(e.url).pathname.startsWith("/_next/image")) return z(e, { buildOutput: m, assetsFetcher: t.ASSETS, imagesConfig: f.images });
    let o = B(e);
    return ee({ request: o, ctx: r, assetsFetcher: t.ASSETS }, f, m, _);
  }));
} };
...
// .wrangler/tmp/pages-1PtEA0/sc5eestm1xp.js
...
// .wrangler/tmp/bundle-Y1tYxp/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Y1tYxp/middleware-loader.entry.ts
